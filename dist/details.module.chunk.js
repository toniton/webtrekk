...
var DetailsComponent = /** @class */ (function () {
    function DetailsComponent(route, router, customerService) {
        var _this = this;
        this.route = route;
        this.router = router;
        ...
        this.model = new __WEBPACK_IMPORTED_MODULE_4__models_customer__["a" /* Customer */]();
        this.subscribeToRouteParams = function () {
            _this.route.params.subscribe(function (params) {
                var id = params.id;
                if (id) {
                    _this.customer$ = _this.getCustomer(id);
                }
            });
        };
        this.getCustomer = function (id) {
            return _this.customerService.getCustomer(id)
                .do(function (data) { return _this.setModelValues(data); });
        };
        this.subscribeToQueryParams = function () {
        ...
        this.setModelValues = function (data) {
            _this.model = __WEBPACK_IMPORTED_MODULE_5_lodash__["merge"](_this.model, data);
        };
        this.gotoEditDetails = function (id, edit) {
    ...
    DetailsComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            animations: [
                Object(__WEBPACK_IMPORTED_MODULE_2__config_animations__["b" /* FLY_IN_OUT_LIST_PARENT */])()
            ]
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__directives_directives_module__ = __webpack_require__("./src/app/directives/directives.module.ts");
...
var DetailsModule = /** @class */ (function () {
    ...
    DetailsModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            declarations: [__WEBPACK_IMPORTED_MODULE_2__details_component__["a" /* DetailsComponent */]]
        })
    ], DetailsModule);
