...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.router.events
            ...
            .subscribe(function (event) { return _this.titleService.setTitle('Webtrekk | ' + event['title']); });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__guards_guards_module__ = __webpack_require__("./src/app/guards/guards.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__resolvers_resolvers_module__ = __webpack_require__("./src/app/resolvers/resolvers.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__services_services_module__ = __webpack_require__("./src/app/services/services.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__widgets_widgets_module__ = __webpack_require__("./src/app/widgets/widgets.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__widgets_alert_alert_service__ = __webpack_require__("./src/app/widgets/alert/alert.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__directives_directives_module__ = __webpack_require__("./src/app/directives/directives.module.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_10__guards_guards_module__["a" /* GuardsModule */],
                __WEBPACK_IMPORTED_MODULE_11__resolvers_resolvers_module__["a" /* ResolversModule */],
                __WEBPACK_IMPORTED_MODULE_13__widgets_widgets_module__["a" /* WidgetsModule */],
                __WEBPACK_IMPORTED_MODULE_12__services_services_module__["a" /* ServicesModule */]
            ],
            declarations: [
                __WEBPACK_IMPORTED_MODULE_4__app_component__["a" /* AppComponent */]
            ],
            providers: [
                __WEBPACK_IMPORTED_MODULE_14__widgets_alert_alert_service__["a" /* AlertService */],
                {
...
/* unused harmony export FLY_IN_OUT */
/* harmony export (immutable) */ __webpack_exports__["a"] = FLY_IN_OUT_LIST;
/* harmony export (immutable) */ __webpack_exports__["b"] = FLY_IN_OUT_LIST_PARENT;
...
function FLY_IN_OUT() {
    return Object(__WEBPACK_IMPORTED_MODULE_0__angular_animations__["n" /* trigger */])('flyInOut', [
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_animations__["k" /* state */])('', Object(__WEBPACK_IMPORTED_MODULE_0__angular_animations__["l" /* style */])({ opacity: 0.4, transform: 'translateY(-10%)' })),
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_animations__["m" /* transition */])('* => in', [
            Object(__WEBPACK_IMPORTED_MODULE_0__angular_animations__["e" /* animate */])('0.6s 0.2s ease-out', Object(__WEBPACK_IMPORTED_MODULE_0__angular_animations__["l" /* style */])({
                opacity: 1,
                transform: 'translateY(0)'
            }))
        ]),
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_animations__["m" /* transition */])('in => out', [
            Object(__WEBPACK_IMPORTED_MODULE_0__angular_animations__["e" /* animate */])('0.3s ease-out', Object(__WEBPACK_IMPORTED_MODULE_0__angular_animations__["l" /* style */])({
                opacity: 0,
...
module.exports = "<nav class=\"navbar navbar-light\">\n  <div class=\"container-fluid w-100\">\n    <a class=\"navbar-brand\" routerLink=\"/\">\n      <img class=\"logo\" src=\"assets/images/webtrekk-logo.png\" alt=\"Webtrekk\" />\n    </a>\n    <div *ngIf=\"searchOverlay\" class=\"modal-backdrop show\"></div>\n    <form class=\"form my-0\" #form=\"ngForm\" (ngSubmit)=\"onSubmit(form)\" autocomplete=\"off\" novalidate>\n      <div class=\"form-group mb-0\">\n        <div class=\"input-group search-bar\" [class.is-invalid]=\"(person.errors && person.dirty) || (person.errors && person.touched)\">\n          <input aria-describedby=\"personHelp\" class=\"form-control\" [class.is-invalid]=\"(person.errors && person.dirty) || (person.errors && person.touched)\"\n            id=\"name\" name=\"name\" placeholder=\"Search customer\" type=\"search\" [(ngModel)]=\"model.name\" #person=\"ngModel\" (input)=\"searchType($event.target.value)\"\n            (focus)=\"setSearchOverlayStatus(true)\" (focusout)=\"setSearchOverlayStatus(false)\" required/>\n          <i class=\"fa fas fa-search\"></i>\n        </div>\n      </div>\n    </form>\n  </div>\n</nav>"
...
var PartialHeaderComponent = /** @class */ (function () {
    ...
    PartialHeaderComponent.prototype.setSearchOverlayStatus = function (status) {
        this.searchOverlay = status;
    };
    PartialHeaderComponent.prototype.onSubmit = function (form) {
...
var DatePickerDirective = /** @class */ (function () {
    function DatePickerDirective(el, cdRef) {
        var _this = this;
        this.el = el;
        this.cdRef = cdRef;
    ...
    DatePickerDirective.prototype.ngOnInit = function () {
        ...
        $(this.el.nativeElement).datepicker({
            ...
            todayBtn: 'linked',
            todayHighlight: true
        }).datepicker('setDate', new Date(this.dateValue)).on('changeDate', function (e) {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["HostBinding"])('value'),
        __metadata("design:type", Object)
    ], DatePickerDirective.prototype, "dateValue", void 0);
    __decorate([
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__date_picker_directive__ = __webpack_require__("./src/app/directives/date-picker.directive.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__loading_button_directive__ = __webpack_require__("./src/app/directives/loading-button.directive.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__password_meter_directive__ = __webpack_require__("./src/app/directives/password-meter.directive.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DirectivesModule = /** @class */ (function () {
    ...
    DirectivesModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            declarations: [__WEBPACK_IMPORTED_MODULE_2__directives_trim_directive__["a" /* TrimDirective */], __WEBPACK_IMPORTED_MODULE_3__directives_numbers_only_directive__["a" /* NumbersOnlyDirective */], __WEBPACK_IMPORTED_MODULE_4__directives_equal_validator_directive__["a" /* EqualValidator */], __WEBPACK_IMPORTED_MODULE_5__date_picker_directive__["a" /* DatePickerDirective */], __WEBPACK_IMPORTED_MODULE_6__loading_button_directive__["a" /* LoadingButtonDirective */], __WEBPACK_IMPORTED_MODULE_7__password_meter_directive__["a" /* PasswordMeterDirective */]],
            exports: [__WEBPACK_IMPORTED_MODULE_2__directives_trim_directive__["a" /* TrimDirective */], __WEBPACK_IMPORTED_MODULE_3__directives_numbers_only_directive__["a" /* NumbersOnlyDirective */], __WEBPACK_IMPORTED_MODULE_4__directives_equal_validator_directive__["a" /* EqualValidator */], __WEBPACK_IMPORTED_MODULE_5__date_picker_directive__["a" /* DatePickerDirective */], __WEBPACK_IMPORTED_MODULE_6__loading_button_directive__["a" /* LoadingButtonDirective */], __WEBPACK_IMPORTED_MODULE_7__password_meter_directive__["a" /* PasswordMeterDirective */]]
        })
    ], DirectivesModule);
...
var EqualValidator = /** @class */ (function () {
    ...
    EqualValidator = EqualValidator_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Directive"])({
            ...
            providers: [{ provide: __WEBPACK_IMPORTED_MODULE_1__angular_forms__["NG_VALIDATORS"], useExisting: EqualValidator_1, multi: true }]
        }),
...
/***/ "./src/app/directives/loading-button.directive.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var LoadingButtonDirective = /** @class */ (function () {
    ...
    LoadingButtonDirective.prototype.onClick = function () {
    ...
    LoadingButtonDirective.prototype.ngOnChanges = function (changes) {
        ...
        if (!changes.loading.firstChange && changes.loading.currentValue) {
            this.renderer.setProperty(this.el.nativeElement, 'innerHTML', '<span><span class="loading-dot">•</span><span class="loading-dot">•</span><span class="loading-dot">•</span></span>');
        }
        else {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["HostBinding"])('style.min-width.px'),
        __metadata("design:type", Number)
    ], LoadingButtonDirective.prototype, "width", void 0);
    __decorate([
        ...
        __metadata("design:type", Object)
    ], LoadingButtonDirective.prototype, "loading", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["HostListener"])('click'),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", void 0)
    ], LoadingButtonDirective.prototype, "onClick", null);
...
var NumbersOnlyDirective = /** @class */ (function () {
    ...
    NumbersOnlyDirective = NumbersOnlyDirective_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Directive"])({
            ...
            providers: [{ provide: __WEBPACK_IMPORTED_MODULE_1__angular_forms__["NG_VALIDATORS"], useExisting: NumbersOnlyDirective_1, multi: true }]
        }),
        __metadata("design:paramtypes", [])
...
/***/ "./src/app/directives/password-meter.directive.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var PasswordMeterDirective = /** @class */ (function () {
    ...
    Object.defineProperty(PasswordMeterDirective.prototype, "hostClasses", {
        get: function () {
            return [
                this.class,
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Object)
    ], PasswordMeterDirective.prototype, "class", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["HostBinding"])('class'),
        __metadata("design:type", String),
        __metadata("design:paramtypes", [])
    ], PasswordMeterDirective.prototype, "hostClasses", null);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__config_base_model__ = __webpack_require__("./src/app/config/base-model.ts");
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var Customer = /** @class */ (function (_super) {
    ...
    function Customer() {
        ...
        _this.getFullName = function () {
            return _this.name.first + " " + _this.name.last;
        };
        return _this;
    }
    return Customer;
}(__WEBPACK_IMPORTED_MODULE_0__config_base_model__["a" /* BaseModel */]));
...
var CustomerService = /** @class */ (function () {
    ...
    CustomerService.prototype.getCustomer = function (id) {
        ...
        return this.http
            .get(__WEBPACK_IMPORTED_MODULE_1__environments_environment__["a" /* environment */].API_URL + ":" + __WEBPACK_IMPORTED_MODULE_1__environments_environment__["a" /* environment */].API_PORT + "/" + __WEBPACK_IMPORTED_MODULE_1__environments_environment__["a" /* environment */].PREFIX + "/" + __WEBPACK_IMPORTED_MODULE_2__config_endpoint__["a" /* endpoints */].CUSTOMER + "/" + id)
            .map(function (response) { return new __WEBPACK_IMPORTED_MODULE_4__models_customer__["a" /* Customer */]().deserialize(response.data); });
    };
    ;
    CustomerService.prototype.getCustomers = function (page) {
        if (page === void 0) { page = null; }
        if (page !== null) {
            return this.http
                .get(__WEBPACK_IMPORTED_MODULE_1__environments_environment__["a" /* environment */].API_URL + ":" + __WEBPACK_IMPORTED_MODULE_1__environments_environment__["a" /* environment */].API_PORT + "/" + __WEBPACK_IMPORTED_MODULE_1__environments_environment__["a" /* environment */].PREFIX + "/" + __WEBPACK_IMPORTED_MODULE_2__config_endpoint__["a" /* endpoints */].CUSTOMER, {
                params: {
                    page: page
                }
            });
        }
        return this.http.get(__WEBPACK_IMPORTED_MODULE_1__environments_environment__["a" /* environment */].API_URL + ":" + __WEBPACK_IMPORTED_MODULE_1__environments_environment__["a" /* environment */].API_PORT + "/" + __WEBPACK_IMPORTED_MODULE_1__environments_environment__["a" /* environment */].PREFIX + "/" + __WEBPACK_IMPORTED_MODULE_2__config_endpoint__["a" /* endpoints */].CUSTOMER);
    };
    ;
    CustomerService.prototype.createCustomer = function (customer) {
        return this.http
            .post(__WEBPACK_IMPORTED_MODULE_1__environments_environment__["a" /* environment */].API_URL + ":" + __WEBPACK_IMPORTED_MODULE_1__environments_environment__["a" /* environment */].API_PORT + "/" + __WEBPACK_IMPORTED_MODULE_1__environments_environment__["a" /* environment */].PREFIX + "/" + __WEBPACK_IMPORTED_MODULE_2__config_endpoint__["a" /* endpoints */].CUSTOMER, customer);
    };
    ;
    CustomerService.prototype.updateCustomer = function (customer) {
        return this.http
            .put(__WEBPACK_IMPORTED_MODULE_1__environments_environment__["a" /* environment */].API_URL + ":" + __WEBPACK_IMPORTED_MODULE_1__environments_environment__["a" /* environment */].API_PORT + "/" + __WEBPACK_IMPORTED_MODULE_1__environments_environment__["a" /* environment */].PREFIX + "/" + __WEBPACK_IMPORTED_MODULE_2__config_endpoint__["a" /* endpoints */].CUSTOMER + "/" + customer._id, customer).map(function (response) { return response.data; });
    };
    ;
    CustomerService.prototype.deleteCustomer = function (id) {
        return this.http
            .delete(__WEBPACK_IMPORTED_MODULE_1__environments_environment__["a" /* environment */].API_URL + ":" + __WEBPACK_IMPORTED_MODULE_1__environments_environment__["a" /* environment */].API_PORT + "/" + __WEBPACK_IMPORTED_MODULE_1__environments_environment__["a" /* environment */].PREFIX + "/" + __WEBPACK_IMPORTED_MODULE_2__config_endpoint__["a" /* endpoints */].CUSTOMER + "/" + id);
    };
    ;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__("./node_modules/@angular/common/esm5/common.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__customer_service__ = __webpack_require__("./src/app/services/customer.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ServicesModule = /** @class */ (function () {
    ...
    ServicesModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            declarations: [],
            providers: [
                __WEBPACK_IMPORTED_MODULE_2__customer_service__["a" /* CustomerService */]
            ]
        })
    ], ServicesModule);
...
/***/ "./src/app/utility/date.format.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function formatDate(date, format) {
    return __WEBPACK_IMPORTED_MODULE_0_moment__(date).format(format);
}
...
/***/ "./src/app/widgets/card-item/card-item.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"card\" style=\"min-width: 16rem;\">\n  <div class=\"card-body\">\n    <h5 class=\"card-title\">{{ item?.name?.first }} {{ item?.name?.last }}</h5>\n    <h6 class=\"card-subtitle mb-2 text-muted\"> {{ formatDateOfBirth(item?.birthday) }}</h6>\n    <p class=\"card-text\"> {{ item?.customerLifetimeValue }}</p>\n  </div>\n  <div class=\"card-footer\">\n    <div class=\"d-flex justify-content-end\">\n      <div class=\"d-inline-block card-button-group\">\n        <button type=\"button\" class=\"btn\" (click)=\"editClicked($event)\">\n          <i class=\"fa far fa-pencil\"></i>\n        </button>\n        <button type=\"button\" class=\"btn\" (click)=\"deleteClicked($event)\">\n          <i class=\"fa far fa-trash\"></i>\n        </button>\n      </div>\n    </div>\n  </div>\n</div>"

/***/ }),

/***/ "./src/app/widgets/card-item/card-item.component.scss":
/***/ (function(module, exports) {

module.exports = ".card .card-button-group {\n  padding: 2px;\n  border: 1px solid #eeeeee;\n  border-radius: 40px;\n  background: #fafafa; }\n  .card .card-button-group button {\n    background: #ffffff;\n    border: 1px solid #eeeeee;\n    border-radius: 40px;\n    color: #4e4e4e;\n    height: 40px;\n    padding: 0;\n    text-align: center;\n    width: 40px; }\n  .card .card-button-group button:hover {\n      background: #eeeeee; }\n  .card .card-button-group button:hover i {\n        -webkit-transition: 0.2s all ease-in-out;\n        transition: 0.2s all ease-in-out;\n        -webkit-transform: rotate(-15deg) scale(1.3);\n                transform: rotate(-15deg) scale(1.3); }\n  .card, .list-group-item {\n  -webkit-transition: 0.3s all cubic-bezier(0.25, 0.46, 0.45, 0.94);\n  transition: 0.3s all cubic-bezier(0.25, 0.46, 0.45, 0.94); }\n  .card:hover, .list-group-item:hover {\n    background-image: linear-gradient(180deg, rgba(255, 255, 255, 0) 54%, #fff), linear-gradient(70deg, #dbedff 30%, #ebfff0);\n    background-size: auto 80px;\n    background-repeat: no-repeat;\n    -webkit-transform: scale(1.02);\n            transform: scale(1.02); }\n"

/***/ }),

/***/ "./src/app/widgets/card-item/card-item.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CardItemComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utility_date_format__ = __webpack_require__("./src/app/utility/date.format.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CardItemComponent = /** @class */ (function () {
    ...
    CardItemComponent.prototype.editClicked = function ($event) {
        if (this.onEdit) {
            this.onEdit.emit($event);
        }
    };
    CardItemComponent.prototype.deleteClicked = function ($event) {
        if (this.onDelete) {
            this.onDelete.emit($event);
        }
    };
    CardItemComponent.prototype.formatDateOfBirth = function (dob) {
        return Object(__WEBPACK_IMPORTED_MODULE_1__utility_date_format__["b" /* formatDate */])(dob, __WEBPACK_IMPORTED_MODULE_1__utility_date_format__["a" /* DATEFORMAT */].easyToRead);
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Object)
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])(),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"])
    ], CardItemComponent.prototype, "onEdit", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])(),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"])
    ], CardItemComponent.prototype, "onDelete", void 0);
    CardItemComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-card-item',
            template: __webpack_require__("./src/app/widgets/card-item/card-item.component.html"),
            styles: [__webpack_require__("./src/app/widgets/card-item/card-item.component.scss")]
        }),
        __metadata("design:paramtypes", [])
    ], CardItemComponent);
...
var FilterBarComponent = /** @class */ (function () {
    ...
    FilterBarComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            template: __webpack_require__("./src/app/widgets/filter-bar/filter-bar.component.html"),
            styles: [__webpack_require__("./src/app/widgets/filter-bar/filter-bar.component.scss")]
        }),
        __metadata("design:paramtypes", [])
    ], FilterBarComponent);
...
var LoaderComponent = /** @class */ (function () {
    function LoaderComponent(router, activatedRoute, loaderService) {
        ...
        this.subscribeToLoadingState = function () {
            _this.loaderService.getLoadingState().subscribe(function (showLoading) {
                setTimeout(function () {
        ...
        this.subscribeToNavigationStart = function () {
            _this.router.events
                .filter(function (event) { return event instanceof __WEBPACK_IMPORTED_MODULE_1__angular_router__["d" /* NavigationStart */]; })
                .map(function () { return _this.activatedRoute; })
                .subscribe(function () { return _this.setLoadingState(true); });
        };
        this.subscribeToNavigationEnd = function () {
            _this.router.events
                .filter(function (event) { return event instanceof __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* NavigationEnd */]; })
                .map(function () { return _this.activatedRoute; })
                .subscribe(function () { return _this.setLoadingState(false); });
        };
        this.subscribeToNavigationCancel = function () {
            _this.router.events
        ...
        this.setLoadingState = function (state) {
            _this.loaderService.getLoadingState().next(state);
        };
    }
    ...
    LoaderComponent.prototype.getRandomIndex = function () {
...
/***/ "./src/app/widgets/modal/modal.component.html":
/***/ (function(module, exports) {
...
/***/ "./src/app/widgets/modal/modal.component.scss":
/***/ (function(module, exports) {
...
/***/ "./src/app/widgets/modal/modal.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var ModalComponent = /** @class */ (function () {
    function ModalComponent(el) {
        ...
        this.show = function () {
            ...
            $(_this.modal.nativeElement).find('.modal').modal(options);
        };
        this.hide = function () {
            $(_this.modal.nativeElement).find('.modal').modal('hide');
        };
        this.dispose = function () {
            $(_this.modal.nativeElement).find('.modal').modal('dispose');
        };
        this.modal = el;
    }
    ModalComponent.prototype.ngOnInit = function () {
        var _this = this;
        $(this.modal.nativeElement).find('.modal').on('show.bs.modal', function (e) {
            _this.state = 'in';
        });
        $(this.modal.nativeElement).find('.modal').on('hide.bs.modal', function (e) {
            _this.state = 'out';
        });
        $(this.modal.nativeElement).find('.modal').on('hidden.bs.modal', function (e) {
            _this.state = '';
        });
    };
    __decorate([
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Object)
    ], ModalComponent.prototype, "focus", void 0);
    ModalComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-modal',
            template: __webpack_require__("./src/app/widgets/modal/modal.component.html"),
            styles: [__webpack_require__("./src/app/widgets/modal/modal.component.scss")],
            animations: [
            // FLY_IN_OUT()
            ]
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__modal_modal_component__ = __webpack_require__("./src/app/widgets/modal/modal.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__card_item_card_item_component__ = __webpack_require__("./src/app/widgets/card-item/card-item.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__filter_bar_filter_bar_component__ = __webpack_require__("./src/app/widgets/filter-bar/filter-bar.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var WidgetsModule = /** @class */ (function () {
    ...
    WidgetsModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            declarations: [__WEBPACK_IMPORTED_MODULE_4__badge_badge_component__["a" /* BadgeComponent */], __WEBPACK_IMPORTED_MODULE_5__modal_modal_component__["a" /* ModalComponent */], __WEBPACK_IMPORTED_MODULE_6__card_item_card_item_component__["a" /* CardItemComponent */], __WEBPACK_IMPORTED_MODULE_7__filter_bar_filter_bar_component__["a" /* FilterBarComponent */]],
            exports: [
                ...
                __WEBPACK_IMPORTED_MODULE_6__card_item_card_item_component__["a" /* CardItemComponent */],
                __WEBPACK_IMPORTED_MODULE_7__filter_bar_filter_bar_component__["a" /* FilterBarComponent */],
                __WEBPACK_IMPORTED_MODULE_2__widgets_alert_alert_module__["a" /* AlertModule */],
                __WEBPACK_IMPORTED_MODULE_3__widgets_loader_loader_module__["a" /* LoaderModule */]
            ]
        })
